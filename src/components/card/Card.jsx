  ...
  return (
    <div className="card">
      <button
        ...
        className={
          isFaivorite
            ? "card__like-button card__like-button--liked"
            : "card__like-button"
        }
      >
      ...
      <div className="card__footer">
        <div className="card__textbox-price">
          <p className="card__text">
            Цена:<span className="card__price">{splitMoney(item.price)}</span>
          </p>
        </div>
        <button
          onClick={onPlus}
          className={
            isAdded
              ? "card__button-add card__button-add--active"
              : "card__button-add"
          }
        >
          {isAdded ? (
            ...
            >
              <path
                d="M10.6653 5.13124H7.20219V1.66823C7.20219 0.332869 5.13118 0.332869 5.13118 1.66823V5.13124H1.66805C0.332981 5.13124 0.332981 7.20218 1.66805 7.20218H5.13118V10.6652C5.13118 12.0006 7.20219 12.0006 7.20219 10.6652V7.20218H10.6653C12.0006 7.20218 12.0006 5.13124 10.6653 5.13124Z"
                fill="#D3D3D3"
              />
            </svg>
          )}
